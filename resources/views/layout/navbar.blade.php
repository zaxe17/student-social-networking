<nav class="shadow-nav sticky top-0 w-full h-18 bg-[#770d08] px-13 flex justify-between items-center z-50">
    ...
    <div class="flex items-center gap-4">
        ...
        <img
            ...
            class="w-8 h-8 rounded-full object-cover cursor-pointer border"
            alt="Profile">
                ...
                try {
                    ...
                    if (data.profiles.length) {
                        ...
                        data.profiles.forEach(profile => {
                            html += `
                        <a href="/profile/${profile.student_id}" class="block px-4 py-2 hover:bg-gray-100">
                            ${profile.name}
                        </a>`;
                        });
                    }
                    ...
                    if (data.posts.length) {
                        ...
                        data.posts.forEach(post => {
                            html += `
                        <a href="/search/results?q=${encodeURIComponent(post.content)}" class="block px-4 py-2 hover:bg-gray-100">
                            ${post.short_content}
                        </a>`;
                        });
                    }
                    ...
                    if (!html) {
                        html = `<div class="px-4 py-2">No results</div>`;
                    }
