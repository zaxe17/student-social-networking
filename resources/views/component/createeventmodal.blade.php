    ...
    <div class="relative mx-auto my-12 w-[92%] max-w-xl bg-white rounded-xl shadow-lg p-6 overflow-y-auto max-h-[90vh]">
        ...
        <form id="createEventForm" class="mt-5 space-y-4" method="POST" action="{{ route('events.store') }}" enctype="multipart/form-data">
            ...
            <div class="flex items-center gap-3">
                <label class="text-sm text-gray-700 font-medium cursor-pointer">Upload event header:</label>

                <label class="cursor-pointer inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-[#6b1d1d] rounded-lg hover:opacity-90">
                    Choose File
