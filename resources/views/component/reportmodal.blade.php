        ...
        <div class="w-2/5 bg-[#F5F5F5] form-shadow rounded-3xl backdrop-blur-sm overflow-hidden">
            ...
            <form action="" method="" class="flex flex-col gap-3.5 p-8">
                ...
                <div class="flex flex-col">
                    ...
                    <textarea name="" id="" placeholder="" class="shadow-textarea w-full h-25 px-3 focus:outline-none resize-none"></textarea>
                </div>

                <div class="flex justify-center">
                    <button type="submit" class="w-30 flex justify-center items-center py-1.5 text-xl font-medium text-white bg-[#770d08] rounded-md">Submit</button>
                </div>
            </form>
