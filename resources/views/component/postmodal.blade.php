            ...
            <div class="flex-1 overflow-y-auto">
                <div class="border-b border-b-black/50 border-solid p-8 pb-2 mb-5">
                    ...
                    <div class="flex items-center gap-2 mb-8">
                        ...
                        <div class="flex flex-col text-sm">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <span id="modalCategoryIcon"
                                    class="icon bg-[#770d08]"
                                    style="--svg: url('https://api.iconify.design/mdi/tag.svg'); --size: 18px;">
                                </span>
                    ...
                    <div class="flex justify-between items-center mb-3 text-sm text-[#545454]">
                        ...
                        <span
                            id="modalComments"
                            class="text-[#545454] cursor-pointer hover:underline">
                            0 comments
                        </span>
                    </div>
                    {{-- ACTION BUTTONS --}}
                    <div class="flex justify-around items-center mt-3 mb-5">
                        <button id="modalReactBtn"
                            ...
                            <span id="modalHeartIcon"
                                ...
                                data-heart-icon
                                style="--svg: url('https://api.iconify.design/mdi:heart-outline.svg'); --size: 24px;">
                            </span>
                            React
                        </button>
