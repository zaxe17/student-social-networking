            ...
            <form id="profileForm" class="flex flex-col flex-1 overflow-y-auto p-8 gap-6" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <input type="text" name="instagram" value="{{ $loggedInStudent->instagram ?? '' }}"
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <input type="text" name="facebook" value="{{ $loggedInStudent->facebook ?? '' }}"
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <input type="text" name="linkedin" value="{{ $loggedInStudent->linkedin ?? '' }}"
